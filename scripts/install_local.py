...
DEFAULT_SOURCE_SKILL_NAME = "wanglab-imagegen"
DEFAULT_SKILL_NAME = "wanglab-imagegen"
DEFAULT_CODEX_SKILL_ROOT = Path.home() / ".codex" / "skills"


def default_skill_source(repo_root: Path) -> Path:
    return repo_root / "skills" / DEFAULT_SOURCE_SKILL_NAME
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Install Wanglab Imagegen into ~/.codex/skills/wanglab-imagegen by default.")
    parser.add_argument("--source", type=Path, default=default_skill_source(repo_root), help="Skill source directory.")
    parser.add_argument("--skill-name", default=DEFAULT_SKILL_NAME, help="Installed skill directory name. Defaults to wanglab-imagegen.")
